"""Example usages for the `image_to_excel._validation.ValidatingBaseClass` class."""
...
class ActionExample(ValidatingBaseClass):
    """Shows an example usage of the `image_to_excel._validation.ValidatingBaseClass` class."""
...
def run_example() -> None:
    """An example usage of the `image_to_excel._validation.ValidatingBaseClass` class.
